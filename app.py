...
<div class="main-header">
    ...
    <p>Tác giả: Cam Thị Liễu - Trường Tiểu học Đông An - ĐT: 0976 053 372</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Cam Thị Liễu - Trường Tiểu học Đông An - ĐT: 0976 053 372</div>", unsafe_allow_html=True)
